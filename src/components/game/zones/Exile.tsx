...
export function Exile({ cards, isOpponent }: ExileProps) {
  ...
  const handleViewExile = useCallback(() => {
    setExpanded(true);
    closeContextMenu();
  }, [closeContextMenu]);
        ...
        >
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4">
              {cards.length === 0 ? (
                <p className="text-gray-500 text-center py-8">Exile is empty</p>
              ) : (
                      ...
                      >
                        ...
                        {!isOpponent && (
                          <button
                            ...
                            className="px-3 py-1 text-xs bg-purple-600 hover:bg-purple-500 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity"
